...
import { FaultAlertModal } from '@client:common/overlay/fault-alert-modal';
...
export class NavigationContainer extends Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.onShowFaultAlert = this.onShowFaultAlert.bind(this);
    this.onCloseFaultAlert = this.onCloseFaultAlert.bind(this);
  }
    ...
    return (
      <>
        <Navigation
          ...
          onShowFaultAlert={this.onShowFaultAlert}>
          {this.props.children}
        </Navigation>
        <FaultAlertModal
          isOpen={this.state.isFaultAlertModalOpen}
          title='System Alert'
          description='Description of the Fault/Issue detected in the power grid system. This is sample text to demonstrate the modal functionality.'
          onClose={this.onCloseFaultAlert}
        />
      </>
    );
  }
  ...
  onShowFaultAlert() {
    this.setState({ isFaultAlertModalOpen: true });
  }

  onCloseFaultAlert() {
    this.setState({ isFaultAlertModalOpen: false });
  }
