      ...
      case SimulationStatus.RESUMED:
        return (
          <>
            ...
            <Tooltip content='Create congestion in the Power Grid'>
              <BasicButton
                type='positive'
                className={`simulation-control__action create-congestion ${this.props.isCongestionActive ? 'disabled' : ''}`}
                label='Create Congestion'
                onClick={this.props.onCreateCongestion}
                disabled={this.props.isCongestionActive} />
            </Tooltip>
          </>
        );
